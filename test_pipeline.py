...
async def main():
    ...
    # Test Case 1
    test1 = "I need an Funko figurine for my daughter for her birthdate. She likes Disney characters."
    await test_pipeline(test1, "Product Search with brand name and genre goals")
